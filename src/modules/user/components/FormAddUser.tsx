...
import { RegisterParams, useRegisterMutation } from "../../auth/services/registerApiSlice";
...
const FormAddUser = () => {
   ...
   const validationSchema = Yup.object().shape({
      ...
      role: Yup.string().required("This field must be required"),
   });
   ...
   const onSubmit = async (values: RegisterParams, { resetForm }: { resetForm: any }) => {
      try {
         ...
         resetForm({});
         setSuccessMsg("Add user successful !!!");
         setErrorMsg("");
      } catch (error: any) {
